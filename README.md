...
- **Architecture:** Composable Architecture (TCA), MVVM, Swift Concurrency (async/await), Kotlin Multiplatform shared modules
- **Quality:** Swift Testing / XCTest, modularization for testability, GitLab CI/CD and Bitrise pipelines, LaunchDarkly feature flags
- **AI-assisted workflows:** agentic AI tooling for development and code generation, with generated code reviewed and tested before integration — see [Claude-Commands-and-Skills](https://github.com/lbulendev/Claude-Commands-and-Skills)
